...
[Programming Concepts](https://github.com/KielCruey/programming-concepts)
* self-learning repository for general software curiosities 
* repository mostly contains algorithms and data structure ideas

[Audio Plug-ins](https://github.com/KielCruey/plug-ins)
* used the [Juce framework](https://juce.com/) to program plug-ins for digital audio workstations (DAW)
